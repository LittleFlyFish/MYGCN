...
class YourGCN(nn.Module):
    def __init__(self, in_c, hid_c, out_c):
        ...
        self.conv1 = pyg_nn.GMMConv(in_channels=in_c, out_channels=hid_c, kernel_size=10, dim=5)
        self.conv2 = pyg_nn.GMMConv(in_channels=hid_c, out_channels=out_c, kernel_size=10, dim=5)
